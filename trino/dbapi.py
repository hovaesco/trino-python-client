...
class Connection(object):
    ...
    def __init__(
        ...
        experimental_python_types: Optional[bool] = False,
    ...
    def cursor(self, experimental_python_types: bool = False) -> 'trino.dbapi.Cursor':
...
class Cursor(object):
    ...
    def __init__(self,
                 ...
                 experimental_python_types: bool = False) -> None:
